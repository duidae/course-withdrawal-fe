...
export const INIT_STUDENTS: Withdrawal[] = [
  ...
  },
  {
    ...
    applyTime: "2026/05/06 10:23",
    deadline: "2026/05/13 23:59",
    reason:
      "因本學期同時修習多門進階課程，課業負擔過重，經評估後決定集中資源於其他必修科目，故申請停修本課程。",
    status: "approved",
    reviewTime: "2026/05/10 09:15",
    approver: "林俊叡 (教師)",
  ...
  },
  {
    ...
    applyTime: "2026/04/28 13:09",
    deadline: "2026/05/13 23:59",
    reason:
      "本人因每日通勤往返超過四小時，加上工讀兼職，無法妥善安排課後複習與實作時間，學習成效不佳，故申請停修。",
    status: "approved",
    reviewTime: "2026/05/09 11:00",
    approver: "林俊叡 (教師)",
  ...
  },
  {
    ...
    applyTime: "2026/05/07 08:30",
    deadline: "2026/05/13 23:59",
    reason:
      "本人研究所論文進入關鍵撰寫階段，指導教授要求專注研究，難以分心修習本課程，故申請停修。",
    status: "declined",
    reviewTime: "2026/05/10 16:30",
    approver: "林俊叡 (教師)",
  ...
  },
  {
    ...
    applyTime: "2026/05/02 17:25",
    deadline: "2026/05/13 23:59",
    reason:
      "系上必修實驗課與本課程時段重疊，學期中才發現衝突，為能完成必修課程，故申請停修。",
    status: "approved",
    reviewTime: "2026/05/08 10:20",
    approver: "林俊叡 (教師)",
