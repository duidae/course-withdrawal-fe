export const messages_En: Record<string, string> = {
  ...
  "studentDashboard.status.notStarted.title": "Withdrawal applications for this course are not open yet.",
  "studentDashboard.status.notStarted.message": "You cannot submit a withdrawal application through NTU COOL. Please contact the academic affairs office at your home institution for assistance.",
  "studentDashboard.status.notEnabled.title": "Withdrawal applications are not available for this course.",
  "studentDashboard.status.notEnabled.message": "You cannot submit a withdrawal application through NTU COOL. Please contact the academic affairs office at your home institution for assistance.",
  ...
  "studentDashboard.panel.submittedAt": "- Submitted at: {time}",
  "studentDashboard.panel.reviewComment": "Review Comment",
  "studentDashboard.panel.noComment": "- None",
  "studentDashboard.panel.reviewer": "- Reviewer {name}",
  "studentDashboard.panel.reviewedAt": "- Reviewed at: {time}",
